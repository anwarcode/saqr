exports.run = (client, message, args) =>
{
  ...
  if (!member) return message.channel.send("Use `!saqr addpoints <@member> <kills> [<top>]` format");
  args.shift();
  ...
  if (isNaN(kills)) return message.channel.send("Use `!saqr points <kills> [<top>]` format");
